...
exports.searchFields = [
    {
        ...
        type: 'string',
        default: '',
        description: 'Cloudinary search expression. Examples: <code>tags=cat AND uploaded_at>1d</code>, <code>folder:products/*</code>, <code>tags="back to school"</code> (quote values with spaces). Leave empty to match all assets. <a href="https://cloudinary.com/documentation/admin_api#expression_fields" target="_blank">Full expression syntax →</a>',
        displayOptions: {
            show: {
                resource: ['asset'],
                operation: ['search'],
    ...
    },
    {
        ...
        default: ['image'],
        description: 'Resource types to search. Cloudinary defaults to image-only — select Video and/or Raw to include them. Ignored if your Expression already contains <code>resource_type:</code>.',
        displayOptions: {
            show: {
                resource: ['asset'],
                operation: ['search'],
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                type: 'string',
                default: 'created_at',
                description: 'Field to sort results by (e.g. <code>created_at</code>, <code>public_id</code>, <code>uploaded_at</code>)',
            },
            {
