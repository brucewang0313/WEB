...
exports.assetFields = [
    ...
    },
    {
        ...
        type: 'string',
        default: '',
        description: 'Asset(s) to tag, by public ID. Paste a single public_id, several separated by commas, or wire up an expression — both single values and arrays from expressions are accepted. Cloudinary\'s tag-append endpoint is keyed on public_id; asset_id is not accepted here.',
    ...
    },
    {
        ...
        default: 'upload',
        description: 'The "type" property of the asset (as returned by Cloudinary on the asset object). Must match — public_ids are scoped to (resource_type, type), so an asset stored as "authenticated" is invisible to the default "upload" lookup.',
        displayOptions: {
            show: {
                resource: ['asset'],
                operation: ['updateTags'],
    ...
    },
    {
        ...
        type: 'string',
        default: '',
        description: 'Asset(s) to delete, by public ID. Paste a single public_id, several separated by commas, or wire up an expression — both single values and arrays from expressions are accepted.',
        hint: 'A single public_id is fine — no commas needed. Expressions returning an array also work.',
        placeholder: 'docs/strawberry  or  docs/strawberry, docs/owl',
        required: true,
        displayOptions: {
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                type: 'boolean',
                default: false,
                description: 'Whether to keep the original asset and only delete its derived (transformed) versions',
            },
            {
            ...
            },
            {
                ...
                type: 'string',
                default: '',
                description: 'Comma-separated list of transformation strings; only the listed derived assets are deleted',
            },
        ],
    },
    {
