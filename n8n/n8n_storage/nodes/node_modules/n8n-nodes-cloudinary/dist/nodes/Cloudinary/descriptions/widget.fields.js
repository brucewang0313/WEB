...
const SHOW = { show: { ...RES_OP } };
const SHOW_V1 = { show: { ...RES_OP, '@version': [1] } };
const SHOW_V2 = { show: { ...RES_OP, '@version': [{ _cnd: { gte: 2 } }] } };
        ...
        options: [
            {
                ...
                type: 'boolean',
                default: false,
                description: 'Whether to auto-generate captions from the spoken audio, shown as a track the viewer can toggle on or off. The captions are in the video\'s original spoken language — to also offer captions translated into other languages, use Subtitle Languages below.',
            },
            {
                ...
                description: 'The name shown for the auto-generated captions track in the player\'s captions menu. Set this to match the video\'s spoken language (e.g. "English", "Español").',
            ...
            },
            {
                ...
                type: 'boolean',
                default: false,
                description: 'Whether to auto-generate chapter markers so viewers can jump between sections of the video',
            },
            {
                ...
                type: 'boolean',
                default: true,
                description: 'Whether to show the chapters button in the player, which opens the list of chapters so viewers can navigate. Shown only when Generate Chapters is on; turn off to keep the chapters available without surfacing the button.',
