namespace Mvc7_DependencyInjection.Services
{
    ...
    {
        public string Caption { get; } = "Zipcode";
        ...
        public string QueryZipcode(string cityName, string districtName)
        {
            ...
            {
                return "Error : Must provide the City & District Name";
            }

            //1.查詢City
            var _city = Cities.FirstOrDefault(c => c.CityName.Contains(cityName));
            ...
            var _district = _city.Districts.FirstOrDefault(d => d.Name.Contains(districtName));
            ...
            string zcode = Cities.FirstOrDefault(c => c.CityName.Contains(cityName)).Districts
                                 .FirstOrDefault(d => d.Name.Contains(districtName)).Zipcode;
